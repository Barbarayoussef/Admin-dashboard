...
let schema = z.object({
  ...
  password: z
    ...
    .regex(
      /^[A-Za-z0-9]{8,30}$/,
      "Password must be alphanumeric and 8-30 characters",
    ),
});
      ...
      <main className="flex items-center justify-center min-h-screen">
        <div className=" w-full max-w-sm bg-neutral-primary-soft p-6 border border-default rounded-base shadow-xs">
          <form onSubmit={handleSubmit(doRegister)}>
            ...
            <button
              type="submit"
              className="my-10text-white bg-brand box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none w-full mb-3"
            >
              Submit
            </button>
          </form>
